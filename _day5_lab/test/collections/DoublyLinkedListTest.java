...
class DoublyLinkedListTest {
	...
	@Test
	void deleteIntermediateElementInList() {
		list.addAtFront(10);
		list.addAtFront(5);
		list.addAtFront(1);

		list.delete(5);
		Object[] allElements = list.getAllElements();
		assertTrue(allElements.length == 2);
		assertTrue(allElements[0].equals(1));
		assertTrue(allElements[1].equals(10));
	}
