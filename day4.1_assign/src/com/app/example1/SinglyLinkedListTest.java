...
class SinglyLinkedListTest {
	...
	@Test
	void testdeleteElementUsingTail1() {
		SinglyLinkedList slist = new SinglyLinkedList();
		int element1 = 10;
		int element2 = 20;

		assertThrows(RuntimeException.class, () -> {
			slist.deleteElementUsingTail(100);
		});

		slist.AddAtPos(element1, 1); 
		assertTrue(slist.deleteElementUsingTail(10) == 10);

	}
	
	@Test
	void testdeleteElementUsingTail2() {
		SinglyLinkedList slist = new SinglyLinkedList();
		int element1 = 10;
		int element2 = 20;
		...
		assertTrue((slist.deleteElementUsingTail(10) == 10) &&
				(slist.deleteElementUsingTail(20) == 20));
	}

	@Test
	void testdeleteElementUsingTail22() {
		SinglyLinkedList slist = new SinglyLinkedList();
		int element1 = 10;
		int element2 = 20;
		int element3 = 30;
		...
		assertTrue((slist.deleteElementUsingTail(30) == 30) &&
				(slist.deleteElementUsingTail(40) == 40) &&
				(slist.deleteElementUsingTail(20) == 20) &&
				(slist.deleteElementUsingTail(10) == 10));
		
		
	}
	@Test
	void testdeleteElementUsingTail3() {
		SinglyLinkedList slist = new SinglyLinkedList();
		int element1 = 10;
		int element2 = 20;
		int element3 = 30;
		...
		assertTrue((slist.deleteElementUsingTail(40) == 40));
		assertTrue(slist.tail.data == 20);

		assertTrue((slist.deleteElementUsingTail(20) == 20));
